...
<html>
    ...
    <body>
        ...
        <table border="0" cellpadding="10"  >
         ...
         <tr>
            <th>Visit Number:</th><td><c:out value="${row.visit_no}"/></td><th align="left">Visit date:</th><td><c:out value="${row.visit_date}"/></td><th>Primary complaint:</th><td><c:out value="${row.primary_complaint}"/></td>
